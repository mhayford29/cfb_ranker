...
/* harmony import */ var axios__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(16);
...
function (_React$Component) {
  ...
  function App(props) {
    ...
    _this.addToRankings = _this.addToRankings.bind(_assertThisInitialized(_this));
    return _this;
  }
  ...
  _createClass(App, [{
    ...
    value: function fetchPoll(pollId) {
      ...
      axios__WEBPACK_IMPORTED_MODULE_4___default.a.get('http://site.api.espn.com/apis/site/v2/sports/football/college-football/rankings').then(function (_ref) {
        var data = _ref.data;
    ...
    value: function fetchTeam(schoolName) {
      ...
      axios__WEBPACK_IMPORTED_MODULE_4___default.a.get("http://site.api.espn.com/apis/site/v2/sports/football/college-football/teams/".concat(schoolName)).then(function (_ref2) {
        var data = _ref2.data;
...
function (_React$Component) {
  ...
  function Rankings(props) {
    ...
    _this.handleMoveUp = _this.handleMoveUp.bind(_assertThisInitialized(_this));
    _this.handleMoveDown = _this.handleMoveDown.bind(_assertThisInitialized(_this));
    return _this;
  }
  ...
  _createClass(Rankings, [{
    ...
    key: "handleMoveUp",
    value: function handleMoveUp(index) {
      var tempRankings = this.state.rankings.slice();
    ...
    key: "handleMoveDown",
    value: function handleMoveDown(index) {
      var tempRankings = this.state.rankings.slice();
      var tempValue = tempRankings[index + 1];
      tempRankings[index + 1] = tempRankings[index];
      tempRankings[index] = tempValue;
    ...
    value: function render() {
      ...
      }, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", null, "This weeks Rankings:"), this.state.rankings.map(function (team, index) {
        return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(RankedTeam, {
          team: team,
          index: index,
          handleDelete: _this2.handleDelete,
          handleMoveUp: _this2.handleMoveUp,
          handleMoveDown: _this2.handleMoveDown
        });
...
var RankedTeam = function RankedTeam(props) {
  return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
    ...
    className: "down",
    onClick: function onClick() {
      return props.handleMoveDown(props.index);
    }
  }, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("i", {
...
function (_React$Component) {
  ...
  _createClass(Navigation, [{
    ...
    value: function render() {
      ...
      }, "Massachusetts"))), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", null, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("span", null, "MAC"), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("span", {
        className: "dropdown-submenu",
        style: {
...
var Poll = function Poll(props) {
  return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", null, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", null, props.poll.name), props.poll.ranks.map(function (team, index) {
    ...
    }, team.current, ". ", team.team.location, " ", team.recordSummary, " ", react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("button", {
      onClick: function onClick() {
...
var Welcome = function Welcome() {
  return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", null, "Welcome!");
};
